...
public class CommonMethods extends BaseClass {
	...
	public static void selectValueFromDD(WebElement element, String text) {
		...
		for (WebElement option : options) {
			...
			if (optionText.equals(text)) {
				...
				System.out.println("Option with text " + text + " has beeen selected");
				isSelected = true;
				break;
			}
		}
	...
	public static void waitForElementBeInvisible(WebElement element, int time) {
		WebDriverWait wait=new WebDriverWait(driver, time);
     ...
     * @param radioText
     */
	public static void clickRadio(List<WebElement> elements, String TextToSelect) {
